...
mock -r fedora-25-x86_64 --chroot "pungi -G -c tigeros-source.ks --name=TigerOS --force && pungi -C -c tigeros-source.ks --name=TigerOS --force && pungi -I -c tigeros-source.ks --name=TigerOS --ver=$(date +%Y%m%d)--sourceisos --force"
